    ...
    <section class="banner">
        <div class="custom-container flex flex-center">
            ...
            <div class="banner__right">
                <div>
                    <img class="banner__img" src="./assets/images/banner_img.png" alt="banner image">
                    <span class="banner__circle circle-bg"></span>
                    <span class="banner__circle circle-border"></span>
                </div>
